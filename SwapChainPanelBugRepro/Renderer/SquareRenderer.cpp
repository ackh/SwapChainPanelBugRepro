...
void SquareRenderer::SetScreenSize(float width, float height)
{
...
void SquareRenderer::RenderFrame()
{
  ...
  _d3dContext->DrawIndexed(INDEX_COUNT, 0, 0);
}


void SquareRenderer::SetDevice(ID3D11Device1* d3dDevice)
{
  _d3dDevice = d3dDevice;
}


void SquareRenderer::SetContext(ID3D11DeviceContext1* d3dContext)
{
  _d3dContext = d3dContext;
}


void SquareRenderer::SetRenderTargetView(ID3D11RenderTargetView* renderTargetView)
{
  _d3dRenderTargetView = renderTargetView;
}


void SquareRenderer::SetDepthStencilView(ID3D11DepthStencilView* depthStencilView)
{
  _d3dDepthStencilView = depthStencilView;
}


void SquareRenderer::CreateDeviceResources()
{
  CreateVertexShader();
  CreatePixelShader();
  CreateVertexBuffer();
...
void SquareRenderer::CreateVertexShader()
{
...
void SquareRenderer::CreatePixelShader()
{
...
void SquareRenderer::CreateVertexBuffer()
{
...
void SquareRenderer::CreateIndexBuffer()
{
...
void SquareRenderer::ConfigurePipeline()
{
